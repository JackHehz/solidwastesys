...
public abstract class Routes {
	...
	public Routes addClass(String controllerKey, Class controllerClass, String viewPath) {
		if (controllerKey == null)
			throw new IllegalArgumentException("The controllerKey can not be null");
		// if (controllerKey.indexOf(".") != -1)
		// throw new IllegalArgumentException("The controllerKey can not contain dot character: \".\"");
	...
	public Routes addClass(String controllerkey, Class  controllerClass) {
		return addClass(controllerkey, controllerClass, controllerkey);
	}
