...
import com.platform.config.routes.*;
...
public class JfinalConfig extends JFinalConfig {
	...
	public void configRoute(Routes routes) { 
		...
		routes.add(new EnterRoutes());
		routes.add(new EnterProRoutes());
		routes.add(new WasteRoutes());
		routes.add(new RregisterinfoRoutes());
		routes.add(new MsjwastecolldispRoutes());
		routes.add(new WastemanageplanRoutes());
		routes.add(new WastemonthreportRoutes());
		routes.add(new CarinformationsearchRoutes());
		routes.add(new DriverRoutes());
		routes.add(new registerRoutes());
		routes.add(new ContractRoutes());
		routes.add(new codeRoutes());
		routes.add(new hangyeRoutes());
		routes.add(new TranmanifestRoutes());
		routes.add(new TransplanRoutes());
		routes.add(new TranswasteRoutes());
		routes.add(new TranswasteplanRoutes());
		//routes.add(new ajaxroutes() );
	...
	public static void main(String[] args) {
		...
		JFinal.start("F:\\workspace\\JFinalUIBV2\\JFinalUIBV2\\WebContent", 8888, "/", 5);
	}
}
