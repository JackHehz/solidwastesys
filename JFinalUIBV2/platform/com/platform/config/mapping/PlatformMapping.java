...
import com.Blog.mvc.blog_test.blog_test;
import com.carinformation.mvc.carinformationsearch.Carinformationsearch;
import com.commonsearch.mvc.hangyeleibie.Hangyeleibie;
import com.commonsearch.mvc.rwastecode.Rwastecode;
import com.contract.mvc.contract.Contract;
import com.driver.mvc.driver.Driver;
import com.enterprises.mvc.enterinfo.enterinfo;
import com.enterprises.mvc.enterinfoprocess.EnterinfoProcess;
import com.enterprises.mvc.registerapproval.Registerapproval;
import com.enterprises.mvc.rwaste.Rwaste;
//import com.manageplan.mvc.wastemanageplan.Wastemanageplan;
import com.manageplan.mvc.wastemanageplan.Wastemanageplan;
import com.manifest.mvc.tranmanifest.Tranmanifest;
import com.monthreport.mvc.wastemonthreport.Wastemonthreport;
import com.msjwastecolldisp.mvc.msjwastecolldisp.Msjwastecolldisp;
import com.plan.mvc.transplan.Transplan;
import com.plan.mvc.transplan.Transplanunion;
import com.rregisterinfo.mvc.rregisterinfo.Reservewaste;
import com.rregisterinfo.mvc.rregisterinfo.Rregisterinfo;

import com.rregisterinfo.mvc.rregisterinfo.Yearreportwaste;
import com.transinfo.mvc.transwaste.Transwaste;
import com.transinfo.mvc.transwaste.Transwasteplan;
...
public class PlatformMapping extends BaseMapping{
	...
	public PlatformMapping(Plugins plugins){
		...
		//arp.addMapping("rwastecode","ids", Rwastecode.class);
		//arp.addMapping("hangyeleibie","ids", Hangyeleibie.class);
		...
		//arp.addMapping("test_blog","ids",blog_test.class);
		arp.addMapping("n_bcommonenterprises","ids",enterinfo.class);
		arp.addMapping("n_bcommonenterprises","ids",EnterinfoProcess.class);
		arp.addMapping("n_rwaste","ids", Rwaste.class);
		arp.addMapping("n_rregisterinfo","ids" ,Rregisterinfo.class);
		arp.addMapping("n_msjwastecolldisp","ids" ,Msjwastecolldisp.class);
		arp.addMapping("n_wastemanageplan","ids" ,Wastemanageplan.class);
		arp.addMapping("n_mmonthreport","ids", Wastemonthreport.class);
		arp.addMapping("n_carinformation","ids", Carinformationsearch.class);
		arp.addMapping("n_driver","ids", Driver.class);
		arp.addMapping("n_register","ids", Registerapproval.class);
		arp.addMapping("n_contract","ids", Contract.class);
		arp.addMapping("n_manifest","ids", Tranmanifest.class);
		arp.addMapping("n_transplan","ids", Transplan.class);
		arp.addMapping("n_transplanunion","ids",Transplanunion.class);
		//arp.addMapping("n_transwaste","ids",Transwaste.class);
		//arp.addMapping("n_test_transplanunion","ids",Transwasteplan.class);
		//arp.addMapping("n_rindustryhazardouswastestable","ids",Yearreportwaste.class);
		//arp.addMapping("n_rreservewaste","ids", Reservewaste.class);
