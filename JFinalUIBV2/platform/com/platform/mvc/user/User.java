...
//全局用户名
	...
	public static final String column_user_flag = "user_flag";
	...
	public static final String sqlId_userids = "platform.user.column_ids";
	...
	public void setUser_flag(String ids){
		set(column_user_flag, user_flag);
	}
	public <T> T getUser_flag() {
		return get(column_user_flag);
	}
