...
public class BaseService {
	...
	public void pagings(String dataSource, SplitPage splitPage, String selectSqlId, String fromSqlId){
		String selectSql = getSql(selectSqlId);
		...
		String sql = getSqlByBeetl(fromSqlId, param, paramValue);
	...
	public void transaddpaging(String dataSource, SplitPage splitPage, String selectSqlId, String fromSqlId){
		String selectSql = getSql(selectSqlId);
		...
		LinkedList<Object> paramValue = new LinkedList<Object>();
		param.put("ids",User.userIds);
		param.put("planfk", Transplan.tranplan_fk);
		//param.put("splitPageFrom", Msjwastecolldisp.column_sys_createdby);
		//param.put("splitPageFroms", User.userName);
	...
	//通用添加分页函数(两个参数)
	public void addpaging(String dataSource, SplitPage splitPage, String selectSqlId, String fromSqlId,String params){
		String selectSql = getSql(selectSqlId);
