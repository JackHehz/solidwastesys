...
public abstract class BaseController extends Controller {
	...
	protected SplitPage splitPagewaste;
	protected SplitPage splitPagereserve;
	protected SplitPage splitPagerutilize;
	...
	protected void pagings(String dataSource, SplitPage splitPage, String selectSqlId, String fromSqlId){


		BaseService.service.pagings(dataSource, splitPage, selectSqlId, fromSqlId);
	...
	protected void transaddpaging(String dataSource, SplitPage splitPage, String selectSqlId, String fromSqlId){


		BaseService.service.transaddpaging(dataSource, splitPage, selectSqlId, fromSqlId);

	}

	protected void addpaging(String dataSource, SplitPage splitPage, String selectSqlId, String fromSqlId,String params){


		BaseService.service.addpaging(dataSource, splitPage, selectSqlId, fromSqlId,params);
