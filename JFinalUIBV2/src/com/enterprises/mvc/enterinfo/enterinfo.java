...
public class enterinfo extends BaseModel<enterinfo> {

	private static final long serialVersionUID = 6761767368352810428L;

	private static Logger log = Logger.getLogger(enterinfo.class);
	
	public static final enterinfo dao = new enterinfo();
	...
	/**
	 * sqlId : Enterprise.enterinfo.splitPageFrom
	 * 描述：分页from
	 */
	public static final String sqlId_splitPage_from = "Enterprise.enterinfo.splitPageFrom";
